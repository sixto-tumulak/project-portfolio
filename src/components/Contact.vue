    ...
    <v-container fluid>
      <v-row justify="center">
        <v-col cols="12" sm="6" md="4" class="social-links">
          ...
          <div>
            <v-btn class="social-icon" href="https://github.com/cherymae26" target="_blank" color="black" dense>
              <v-icon size="30">mdi-github</v-icon>
            </v-btn>

            <v-btn class="social-icon" href="https://www.facebook.com/cherymae.signar.7" target="_blank" color="black" dense>
              <v-icon size="30">mdi-facebook</v-icon>
            </v-btn>

            <v-btn class="social-icon" href="https://www.instagram.com/cheee_mayyy/" target="_blank" color="black" dense>
              <v-icon size="30">mdi-instagram</v-icon>
            </v-btn>

            <v-btn class="social-icon" href="https://open.spotify.com/chemayy" target="_blank" color="black" dense>
      ...
      <p class="text-center text-caption">© 2024 Chery Mae Signar</p>
    </v-container>
  </v-container>
  </v-container>
